      ...
      <form onSubmit={form.handleSubmit((v) => { onAdd(v as Omit<Asset, 'id'>); form.reset({ ...form.getValues(), name: '', symbol: '', amount: 0 }); })} className="space-y-4">
        <FormField control={form.control} name="name" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder={lang.namePlaceholder} {...field} className="bg-slate-50 border-slate-300 h-10 text-sm font-bold focus:ring-black" />
            </FormControl>
        ...
        {hasTicker && (
          <FormField control={form.control} name="symbol" render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder={lang.symbolPlaceholder} {...field} className="bg-slate-50 border-slate-300 h-10 text-sm font-bold uppercase tracking-widest focus:ring-black" />
              </FormControl>
              <FormMessage className="text-xs" />
            </FormItem>
          )} />
          ...
          <FormField control={form.control} name="category" render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} value={field.value}>
                <FormControl>
                  <SelectTrigger className="h-10 bg-slate-50 border-slate-300 text-sm font-bold focus:ring-black">
                    <SelectValue />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
        ...
        <div className="grid grid-cols-1 gap-3">
          <FormField control={form.control} name="amount" render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" step="any" {...field} onChange={e => field.onChange(parseFloat(e.target.value) || 0)} className="h-10 font-bold bg-slate-50 border-slate-300 text-sm focus:ring-black" />
              </FormControl>
              <FormMessage className="text-xs" />
            </FormItem>
          )} />
        ...
        <div className="grid grid-cols-2 gap-3">
          <FormField control={form.control} name="acquisitionDate" render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="date" {...field} className="h-10 font-bold bg-slate-50 border-slate-300 text-sm focus:ring-black" />
              </FormControl>
              <FormMessage className="text-xs" />
            </FormItem>
          )} />
          <FormField control={form.control} name="endDate" render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="date" {...field} value={field.value || ''} className="h-10 font-bold bg-slate-50 border-slate-300 text-sm focus:ring-black" />
              </FormControl>
              <FormMessage className="text-xs" />
            </FormItem>
          )} />
